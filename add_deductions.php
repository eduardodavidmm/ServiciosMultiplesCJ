<?php
		...
		$sql = mysql_query("UPDATE deductions SET garnishments='$garnishments', others='$others', fica='$fica', loans='$loans', healthinsurance='$healthinsurance' WHERE deduction_id='1'");
